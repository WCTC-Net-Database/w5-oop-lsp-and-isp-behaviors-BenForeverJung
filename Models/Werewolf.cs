...
public class Werewolf : IEntity, IScurryable
{
    ...
    {
        Console.WriteLine($"{Name} attacks {target.Name} with a menacing bite.");
    }
    public void Move()
    {
    ...
    {
        Console.WriteLine($"{Name} counter attacks {target.Name} with a menacing bite.");
